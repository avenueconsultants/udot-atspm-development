...
**WP2 (Edge REST downloader client) is implemented and component-tested; its live pilot-box
validation remains** — see doc 08's "Progress" note. WP3 (the object-events decoder) is now
the active coding work package. The Edge API
