...
Configuration options available to the **Config API** container.
...
[View source](https://github.com/avenueconsultants/udot-atspm-development/blob/cb00514fff96355d89cabe291e257d6d39435853/Atspm/Infrastructure/Configuration/Documentation/ApiConfigurationSections.cs#L26)
...
[View source](https://github.com/avenueconsultants/udot-atspm-development/blob/cb00514fff96355d89cabe291e257d6d39435853/Atspm/Infrastructure/Configuration/Documentation/ApiConfigurationSections.cs#L55)
...
> Configuration for reading ATSPM GitHub releases

Configuration values used by the Config API GitHub release service.

[View source](https://github.com/avenueconsultants/udot-atspm-development/blob/cb00514fff96355d89cabe291e257d6d39435853/Atspm/Infrastructure/Configuration/Documentation/ApiConfigurationSections.cs#L82)

| Setting | Type | Default | Required | Options | Environment variable | Description |
| --- | --- | --- | --- | --- | --- | --- |
| `UserAgengt` | `string` | `Not set` | No |  | `GitHubReleaseConfiguration__UserAgengt` | User agent sent when calling the GitHub releases API. |
| `RepositoryOwner` | `string` | `Not set` | No |  | `GitHubReleaseConfiguration__RepositoryOwner` | GitHub repository owner that contains ATSPM releases. |
| `RepositoryName` | `string` | `Not set` | No |  | `GitHubReleaseConfiguration__RepositoryName` | GitHub repository name that contains ATSPM releases. |
...
```json
{
  ...
  "GitHubReleaseConfiguration": {
    "UserAgengt": "replace-me",
    "RepositoryOwner": "replace-me",
    "RepositoryName": "replace-me"
  }
}
```
