...
export const getGetVersionCurrentVersionQueryKey = (
  params?: GetVersionCurrentVersionParams
) => {
  return [`/GetCurrentVersion`, ...(params ? [params] : [])] as const
}

export const getGetVersionCurrentVersionQueryOptions = <
  TData = Awaited<ReturnType<typeof getVersionCurrentVersion>>,
  TError = void,
>(
  params?: GetVersionCurrentVersionParams,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetVersionCurrentVersionQueryKey(params)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getVersionCurrentVersion>>
  > = ({ signal }) => getVersionCurrentVersion(params, signal)
...
export type GetVersionCurrentVersionQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVersionCurrentVersion>>
>
...
export function useGetVersionCurrentVersion<
  TData = Awaited<ReturnType<typeof getVersionCurrentVersion>>,
  TError = void,
>(
  params?: GetVersionCurrentVersionParams,
...
export const getVersionLatestVersionFromPreRelease = (
  ...
  return configRequest<GitHubReleaseDto>({
    url: `/GetLatestVersion(PreRelease=${preRelease})`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetVersionLatestVersionFromPreReleaseQueryKey = (
  preRelease: boolean,
  params?: GetVersionLatestVersionFromPreReleaseParams
) => {
  return [
    `/GetLatestVersion(PreRelease=${preRelease})`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetVersionLatestVersionFromPreReleaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getVersionLatestVersionFromPreRelease>>,
  TError = void,
>(
  preRelease: boolean,
  params?: GetVersionLatestVersionFromPreReleaseParams,
  ...
  const queryKey =
    ...
    getGetVersionLatestVersionFromPreReleaseQueryKey(preRelease, params)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getVersionLatestVersionFromPreRelease>>
  > = ({ signal }) =>
    getVersionLatestVersionFromPreRelease(preRelease, params, signal)
...
export type GetVersionLatestVersionFromPreReleaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVersionLatestVersionFromPreRelease>>
>
...
export function useGetVersionLatestVersionFromPreRelease<
  TData = Awaited<ReturnType<typeof getVersionLatestVersionFromPreRelease>>,
  TError = void,
>(
  preRelease: boolean,
  ...
  const queryOptions = getGetVersionLatestVersionFromPreReleaseQueryOptions(
    preRelease,
    params,
    options
  )
...
export const getVersionVersionHistoryFromPreRelease = (
  ...
  return configRequest<GitHubReleaseDto[]>({
    url: `/GetVersionHistory(PreRelease=${preRelease})`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetVersionVersionHistoryFromPreReleaseQueryKey = (
  preRelease: boolean,
  params?: GetVersionVersionHistoryFromPreReleaseParams
) => {
  return [
    `/GetVersionHistory(PreRelease=${preRelease})`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetVersionVersionHistoryFromPreReleaseQueryOptions = <
  TData = Awaited<ReturnType<typeof getVersionVersionHistoryFromPreRelease>>,
  TError = void,
>(
  preRelease: boolean,
  params?: GetVersionVersionHistoryFromPreReleaseParams,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetVersionVersionHistoryFromPreReleaseQueryKey(preRelease, params)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getVersionVersionHistoryFromPreRelease>>
  > = ({ signal }) =>
    getVersionVersionHistoryFromPreRelease(preRelease, params, signal)
...
export type GetVersionVersionHistoryFromPreReleaseQueryResult = NonNullable<
  Awaited<ReturnType<typeof getVersionVersionHistoryFromPreRelease>>
>
...
export function useGetVersionVersionHistoryFromPreRelease<
  TData = Awaited<ReturnType<typeof getVersionVersionHistoryFromPreRelease>>,
  TError = void,
>(
  preRelease: boolean,
  ...
  const queryOptions = getGetVersionVersionHistoryFromPreReleaseQueryOptions(
    preRelease,
    params,
    options
  )
