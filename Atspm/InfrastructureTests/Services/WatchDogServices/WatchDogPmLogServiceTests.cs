...
// for InfrastructureTests - Utah.Udot.ATSPM.Infrastructure.Services.WatchDogServices.Tests/WatchDogPmLogServiceTests.cs
// 
...
namespace Utah.Udot.ATSPM.Infrastructure.Services.WatchDogServices.Tests
{
    public class WatchDogPmLogServiceTests
    {
        ...
        private readonly Mock<ILogger<WatchDogPmLogService>> _loggerMock;
        ...
        public WatchDogPmLogServiceTests()
        {
            ...
            _loggerMock = new Mock<ILogger<WatchDogPmLogService>>();
