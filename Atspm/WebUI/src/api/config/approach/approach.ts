...
export const getGetApproachDetectorsFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Approach/${key}/detectors?${stringifiedParams}` : `/Approach/${key}/detectors`
}
...
export const getGetApproachDetectorsCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Approach/${key}/detectors/$count?${stringifiedParams}` : `/Approach/${key}/detectors/$count`
}
...
export const getUpsertApproachApproachUrl = (params?: UpsertApproachApproachParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/UpsertApproach?${stringifiedParams}` : `/UpsertApproach`
}
...
export const getGetApproachApproachDtoFromIdUrl = (id: number,
  ...
  return stringifiedParams.length > 0 ? `/GetApproachDto/${id}?${stringifiedParams}` : `/GetApproachDto/${id}`
}
...
export const getGetApproachUrl = (params?: GetApproachParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Approach?${stringifiedParams}` : `/Approach`
}
...
export const getGetApproachCountUrl = (params?: GetApproachCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Approach/$count?${stringifiedParams}` : `/Approach/$count`
}
...
export const getGetApproachFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Approach/${key}?${stringifiedParams}` : `/Approach/${key}`
}
