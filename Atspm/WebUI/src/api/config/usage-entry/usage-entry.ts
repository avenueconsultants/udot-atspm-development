...
export const getGetUsageEntryUrl = (params?: GetUsageEntryParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/UsageEntry?${stringifiedParams}` : `/UsageEntry`
}
...
export const getGetUsageEntryCountUrl = (params?: GetUsageEntryCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/UsageEntry/$count?${stringifiedParams}` : `/UsageEntry/$count`
}
...
export const getGetUsageEntryFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/UsageEntry/${key}?${stringifiedParams}` : `/UsageEntry/${key}`
}
