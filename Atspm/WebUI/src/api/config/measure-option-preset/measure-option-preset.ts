...
export const getGetMeasureOptionPresetMeasureOptionPresetTypesUrl = (params?: GetMeasureOptionPresetMeasureOptionPresetTypesParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/MeasureOptionPreset/GetMeasureOptionPresetTypes?${stringifiedParams}` : `/MeasureOptionPreset/GetMeasureOptionPresetTypes`
}
...
export const getGetMeasureOptionPresetUrl = (params?: GetMeasureOptionPresetParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/MeasureOptionPreset?${stringifiedParams}` : `/MeasureOptionPreset`
}
...
export const getGetMeasureOptionPresetCountUrl = (params?: GetMeasureOptionPresetCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/MeasureOptionPreset/$count?${stringifiedParams}` : `/MeasureOptionPreset/$count`
}
...
export const getGetMeasureOptionPresetFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/MeasureOptionPreset/${key}?${stringifiedParams}` : `/MeasureOptionPreset/${key}`
}
...
export const getDeleteMeasureOptionPresetFromKeyUrl = (key: number,) => {
  ...
  return `/MeasureOptionPreset/${key}`
}
