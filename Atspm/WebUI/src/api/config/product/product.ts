...
export const getGetProductUrl = (params?: GetProductParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Product?${stringifiedParams}` : `/Product`
}
...
export const getGetProductCountUrl = (params?: GetProductCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Product/$count?${stringifiedParams}` : `/Product/$count`
}
...
export const getGetProductFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Product/${key}?${stringifiedParams}` : `/Product/${key}`
}
