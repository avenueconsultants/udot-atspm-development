...
export const getGetRegionLocationsFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Region/${key}/locations?${stringifiedParams}` : `/Region/${key}/locations`
}
...
export const getGetRegionLocationsCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Region/${key}/locations/$count?${stringifiedParams}` : `/Region/${key}/locations/$count`
}
...
export const getGetRegionUrl = (params?: GetRegionParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Region?${stringifiedParams}` : `/Region`
}
...
export const getGetRegionCountUrl = (params?: GetRegionCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Region/$count?${stringifiedParams}` : `/Region/$count`
}
...
export const getGetRegionFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Region/${key}?${stringifiedParams}` : `/Region/${key}`
}
