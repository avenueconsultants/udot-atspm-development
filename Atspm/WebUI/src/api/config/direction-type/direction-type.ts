...
export const getGetDirectionTypeApproachesFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}/approaches?${stringifiedParams}` : `/DirectionType/${key}/approaches`
}
...
export const getGetDirectionTypeApproachesCountFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}/approaches/$count?${stringifiedParams}` : `/DirectionType/${key}/approaches/$count`
}
...
export const getGetDirectionTypePrimaryDirectionsFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}/primaryDirections?${stringifiedParams}` : `/DirectionType/${key}/primaryDirections`
}
...
export const getGetDirectionTypePrimaryDirectionsCountFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}/primaryDirections/$count?${stringifiedParams}` : `/DirectionType/${key}/primaryDirections/$count`
}
...
export const getGetDirectionTypeOpposingDirectionsFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}/opposingDirections?${stringifiedParams}` : `/DirectionType/${key}/opposingDirections`
}
...
export const getGetDirectionTypeOpposingDirectionsCountFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}/opposingDirections/$count?${stringifiedParams}` : `/DirectionType/${key}/opposingDirections/$count`
}
...
export const getGetDirectionTypeUrl = (params?: GetDirectionTypeParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/DirectionType?${stringifiedParams}` : `/DirectionType`
}
...
export const getGetDirectionTypeCountUrl = (params?: GetDirectionTypeCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/$count?${stringifiedParams}` : `/DirectionType/$count`
}
...
export const getGetDirectionTypeFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/DirectionType/${key}?${stringifiedParams}` : `/DirectionType/${key}`
}
