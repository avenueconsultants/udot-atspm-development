...
export const getGetVersionCurrentVersionUrl = (params?: GetVersionCurrentVersionParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/GetCurrentVersion?${stringifiedParams}` : `/GetCurrentVersion`
}
...
export const getGetVersionLatestVersionFromPreReleaseUrl = (preRelease: boolean,
  ...
  return stringifiedParams.length > 0 ? `/GetLatestVersion(PreRelease=${preRelease})?${stringifiedParams}` : `/GetLatestVersion(PreRelease=${preRelease})`
}
...
export const getGetVersionVersionHistoryFromPreReleaseUrl = (preRelease: boolean,
  ...
  return stringifiedParams.length > 0 ? `/GetVersionHistory(PreRelease=${preRelease})?${stringifiedParams}` : `/GetVersionHistory(PreRelease=${preRelease})`
}
