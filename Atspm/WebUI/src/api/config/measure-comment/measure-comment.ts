...
export const getGetMeasureCommentMeasureTypesFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/MeasureComment/${key}/measureTypes?${stringifiedParams}` : `/MeasureComment/${key}/measureTypes`
}
...
export const getGetMeasureCommentMeasureTypesCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/MeasureComment/${key}/measureTypes/$count?${stringifiedParams}` : `/MeasureComment/${key}/measureTypes/$count`
}
...
export const getGetMeasureCommentUrl = (params?: GetMeasureCommentParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/MeasureComment?${stringifiedParams}` : `/MeasureComment`
}
...
export const getGetMeasureCommentCountUrl = (params?: GetMeasureCommentCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/MeasureComment/$count?${stringifiedParams}` : `/MeasureComment/$count`
}
...
export const getGetMeasureCommentFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/MeasureComment/${key}?${stringifiedParams}` : `/MeasureComment/${key}`
}
