...
export const getGetRouteDistancePreviousLocationsFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/${key}/previousLocations?${stringifiedParams}` : `/RouteDistance/${key}/previousLocations`
}
...
export const getGetRouteDistancePreviousLocationsFromKeyQueryKey = (key: number,
    params?: GetRouteDistancePreviousLocationsFromKeyParams,) => {
    return [
    `/RouteDistance/${key}/previousLocations`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetRouteDistancePreviousLocationsCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/${key}/previousLocations/$count?${stringifiedParams}` : `/RouteDistance/${key}/previousLocations/$count`
}
...
export const getGetRouteDistancePreviousLocationsCountFromKeyQueryKey = (key: number,
    params?: GetRouteDistancePreviousLocationsCountFromKeyParams,) => {
    return [
    `/RouteDistance/${key}/previousLocations/$count`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetRouteDistanceNextLocationsFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/${key}/nextLocations?${stringifiedParams}` : `/RouteDistance/${key}/nextLocations`
}
...
export const getGetRouteDistanceNextLocationsFromKeyQueryKey = (key: number,
    params?: GetRouteDistanceNextLocationsFromKeyParams,) => {
    return [
    `/RouteDistance/${key}/nextLocations`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetRouteDistanceNextLocationsCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/${key}/nextLocations/$count?${stringifiedParams}` : `/RouteDistance/${key}/nextLocations/$count`
}
...
export const getGetRouteDistanceNextLocationsCountFromKeyQueryKey = (key: number,
    params?: GetRouteDistanceNextLocationsCountFromKeyParams,) => {
    return [
    `/RouteDistance/${key}/nextLocations/$count`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetRouteDistanceRouteDistanceByLocationIdentifiersFromLocationAAndLocationBUrl = (locationA: string,
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/GetRouteDistanceByLocationIdentifiers(locationA=${locationA},locationB=${locationB})?${stringifiedParams}` : `/RouteDistance/GetRouteDistanceByLocationIdentifiers(locationA=${locationA},locationB=${locationB})`
}
...
export const getGetRouteDistanceRouteDistanceByLocationIdentifiersFromLocationAAndLocationBQueryKey = (locationA: string,
    ...
    params?: GetRouteDistanceRouteDistanceByLocationIdentifiersFromLocationAAndLocationBParams,) => {
    return [
    `/RouteDistance/GetRouteDistanceByLocationIdentifiers(locationA=${locationA},locationB=${locationB})`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetRouteDistanceUrl = (params?: GetRouteDistanceParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance?${stringifiedParams}` : `/RouteDistance`
}
...
export const getGetRouteDistanceCountUrl = (params?: GetRouteDistanceCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/$count?${stringifiedParams}` : `/RouteDistance/$count`
}
...
export const getGetRouteDistanceCountQueryKey = (params?: GetRouteDistanceCountParams,) => {
    return [
    `/RouteDistance/$count`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetRouteDistanceFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/RouteDistance/${key}?${stringifiedParams}` : `/RouteDistance/${key}`
}
...
export const getGetRouteDistanceFromKeyQueryKey = (key: number,
    params?: GetRouteDistanceFromKeyParams,) => {
    return [
    `/RouteDistance/${key}`, ...(params ? [params] : [])
    ] as const;
    }
