...
export const getGetLocationApproachesFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/approaches?${stringifiedParams}` : `/Location/${key}/approaches`
}
...
export const getGetLocationApproachesCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/approaches/$count?${stringifiedParams}` : `/Location/${key}/approaches/$count`
}
...
export const getGetLocationAreasFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/areas?${stringifiedParams}` : `/Location/${key}/areas`
}
...
export const getGetLocationAreasCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/areas/$count?${stringifiedParams}` : `/Location/${key}/areas/$count`
}
...
export const getGetLocationDevicesFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/devices?${stringifiedParams}` : `/Location/${key}/devices`
}
...
export const getGetLocationDevicesCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/devices/$count?${stringifiedParams}` : `/Location/${key}/devices/$count`
}
...
export const getGetLocationCopyLocationToNewVersionFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/CopyLocationToNewVersion?${stringifiedParams}` : `/Location/${key}/CopyLocationToNewVersion`
}
...
export const getDeleteLocationSetLocationTodFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/SetLocationToDeleted?${stringifiedParams}` : `/Location/${key}/SetLocationToDeleted`
}
...
export const getDeleteLocationAllVersionsFromKeyUrl = (key: string,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}/DeleteAllVersions?${stringifiedParams}` : `/Location/${key}/DeleteAllVersions`
}
...
export const getGetLocationLatestVersionOfLocationFromIdentifierUrl = (identifier: string,
  ...
  return stringifiedParams.length > 0 ? `/Location/GetLatestVersionOfLocation(identifier=${identifier})?${stringifiedParams}` : `/Location/GetLatestVersionOfLocation(identifier=${identifier})`
}
...
export const getGetLocationAllVersionsOfLocationFromIdentifierUrl = (identifier: string,
  ...
  return stringifiedParams.length > 0 ? `/Location/GetAllVersionsOfLocation(identifier=${identifier})?${stringifiedParams}` : `/Location/GetAllVersionsOfLocation(identifier=${identifier})`
}
...
export const getGetLocationLatestVersionOfAllLocationsUrl = (params?: GetLocationLatestVersionOfAllLocationsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Location/GetLatestVersionOfAllLocations?${stringifiedParams}` : `/Location/GetLatestVersionOfAllLocations`
}
...
export const getGetLocationDetectionTypeCountUrl = (params?: GetLocationDetectionTypeCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Location/GetDetectionTypeCount?${stringifiedParams}` : `/Location/GetDetectionTypeCount`
}
...
export const getGetLocationLocationsForSearchUrl = (params?: GetLocationLocationsForSearchParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Location/GetLocationsForSearch?${stringifiedParams}` : `/Location/GetLocationsForSearch`
}
...
export const getGetLocationCountUrl = (params?: GetLocationCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Location/$count?${stringifiedParams}` : `/Location/$count`
}
...
export const getGetLocationFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Location/${key}?${stringifiedParams}` : `/Location/${key}`
}
