...
export const getGetAreaLocationsFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Area/${key}/locations?${stringifiedParams}` : `/Area/${key}/locations`
}
...
export const getGetAreaLocationsCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Area/${key}/locations/$count?${stringifiedParams}` : `/Area/${key}/locations/$count`
}
...
export const getGetAreaUrl = (params?: GetAreaParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Area?${stringifiedParams}` : `/Area`
}
...
export const getGetAreaCountUrl = (params?: GetAreaCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Area/$count?${stringifiedParams}` : `/Area/$count`
}
...
export const getGetAreaFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Area/${key}?${stringifiedParams}` : `/Area/${key}`
}
