...
// for WebUI - watch-dog-ignore-event.ts
//
...
export const getGetWatchDogIgnoreEventUrl = (params?: GetWatchDogIgnoreEventParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/WatchDogIgnoreEvent?${stringifiedParams}` : `/WatchDogIgnoreEvent`
}
...
export const getGetWatchDogIgnoreEventCountUrl = (params?: GetWatchDogIgnoreEventCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/WatchDogIgnoreEvent/$count?${stringifiedParams}` : `/WatchDogIgnoreEvent/$count`
}
...
export const getGetWatchDogIgnoreEventFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/WatchDogIgnoreEvent/${key}?${stringifiedParams}` : `/WatchDogIgnoreEvent/${key}`
}
...
export const getDeleteWatchDogIgnoreEventFromKeyUrl = (key: number,) => {
  ...
  return `/WatchDogIgnoreEvent/${key}`
}
