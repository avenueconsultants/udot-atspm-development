...
export const getGetJurisdictionLocationsFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Jurisdiction/${key}/locations?${stringifiedParams}` : `/Jurisdiction/${key}/locations`
}
...
export const getGetJurisdictionLocationsFromKeyQueryKey = (key: number,
    params?: GetJurisdictionLocationsFromKeyParams,) => {
    return [
    `/Jurisdiction/${key}/locations`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetJurisdictionLocationsCountFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Jurisdiction/${key}/locations/$count?${stringifiedParams}` : `/Jurisdiction/${key}/locations/$count`
}
...
export const getGetJurisdictionLocationsCountFromKeyQueryKey = (key: number,
    params?: GetJurisdictionLocationsCountFromKeyParams,) => {
    return [
    `/Jurisdiction/${key}/locations/$count`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetJurisdictionUrl = (params?: GetJurisdictionParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Jurisdiction?${stringifiedParams}` : `/Jurisdiction`
}
...
export const getGetJurisdictionCountUrl = (params?: GetJurisdictionCountParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/Jurisdiction/$count?${stringifiedParams}` : `/Jurisdiction/$count`
}
...
export const getGetJurisdictionCountQueryKey = (params?: GetJurisdictionCountParams,) => {
    return [
    `/Jurisdiction/$count`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getGetJurisdictionFromKeyUrl = (key: number,
  ...
  return stringifiedParams.length > 0 ? `/Jurisdiction/${key}?${stringifiedParams}` : `/Jurisdiction/${key}`
}
...
export const getGetJurisdictionFromKeyQueryKey = (key: number,
    params?: GetJurisdictionFromKeyParams,) => {
    return [
    `/Jurisdiction/${key}`, ...(params ? [params] : [])
    ] as const;
    }
