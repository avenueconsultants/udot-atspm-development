...
export const getAggregationDataTypes = (signal?: AbortSignal) => {
  return dataRequest<DataTypeMeta[]>({
    url: `/api/v1/Aggregation/GetDataTypes`,
    method: 'GET',
    signal,
  })
}
...
export function useGetAggregationDataTypes<
  TData = Awaited<ReturnType<typeof getAggregationDataTypes>>,
  TError = ProblemDetails,
>(options?: {
  query?: UseQueryOptions<
...
export const getAggregationStreamDataFromLocationIdentifier = (
  ...
  return dataRequest<CompressedDataBase>({
    url: `/api/v1/Aggregation/StreamData/${locationIdentifier}`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetAggregationStreamDataFromLocationIdentifierQueryKey = (
  locationIdentifier: string,
  params?: GetAggregationStreamDataFromLocationIdentifierParams
) => {
  return [
    `/api/v1/Aggregation/StreamData/${locationIdentifier}`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetAggregationStreamDataFromLocationIdentifierQueryOptions = <
  TData = Awaited<
    ReturnType<typeof getAggregationStreamDataFromLocationIdentifier>
  >,
  TError = ProblemDetails,
>(
  locationIdentifier: string,
  ...
  const queryKey =
    ...
    getGetAggregationStreamDataFromLocationIdentifierQueryKey(
      locationIdentifier,
      params
    )
  ...
  > = ({ signal }) =>
    getAggregationStreamDataFromLocationIdentifier(
      locationIdentifier,
      params,
      signal
    )
...
export type GetAggregationStreamDataFromLocationIdentifierQueryResult =
  NonNullable<
    Awaited<ReturnType<typeof getAggregationStreamDataFromLocationIdentifier>>
  >
export type GetAggregationStreamDataFromLocationIdentifierQueryError =
  ProblemDetails
...
export function useGetAggregationStreamDataFromLocationIdentifier<
  TData = Awaited<
    ReturnType<typeof getAggregationStreamDataFromLocationIdentifier>
  >,
  TError = ProblemDetails,
>(
  ...
  const queryOptions =
    getGetAggregationStreamDataFromLocationIdentifierQueryOptions(
      locationIdentifier,
      params,
      options
    )
...
export const getAggregationDataFromLocationIdentifier = (
  ...
  return dataRequest<CompressedDataBase[]>({
    url: `/api/v1/Aggregation/GetData/${locationIdentifier}`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetAggregationDataFromLocationIdentifierQueryKey = (
  locationIdentifier: string,
  params?: GetAggregationDataFromLocationIdentifierParams
) => {
  return [
    `/api/v1/Aggregation/GetData/${locationIdentifier}`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetAggregationDataFromLocationIdentifierQueryOptions = <
  TData = Awaited<ReturnType<typeof getAggregationDataFromLocationIdentifier>>,
  TError = ProblemDetails,
>(
  locationIdentifier: string,
  params?: GetAggregationDataFromLocationIdentifierParams,
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetAggregationDataFromLocationIdentifierQueryKey(
      locationIdentifier,
      params
    )
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getAggregationDataFromLocationIdentifier>>
  > = ({ signal }) =>
    getAggregationDataFromLocationIdentifier(locationIdentifier, params, signal)
...
export type GetAggregationDataFromLocationIdentifierQueryResult = NonNullable<
  Awaited<ReturnType<typeof getAggregationDataFromLocationIdentifier>>
>
...
export function useGetAggregationDataFromLocationIdentifier<
  TData = Awaited<ReturnType<typeof getAggregationDataFromLocationIdentifier>>,
  TError = ProblemDetails,
>(
  locationIdentifier: string,
  ...
  const queryOptions = getGetAggregationDataFromLocationIdentifierQueryOptions(
    locationIdentifier,
    params,
    options
  )
...
export const getAggregationStreamDataFromLocationIdentifierAndDataType = (
  locationIdentifier: string,
  dataType:
    | 'AggregationApproachBase'
    | 'ApproachPcdAggregation'
    | 'ApproachSpeedAggregation'
    | 'ApproachSplitFailAggregation'
    | 'ApproachYellowRedActivationAggregation'
    | 'DetectorEventCountAggregation'
    | 'PhaseCycleAggregation'
    | 'PhaseLeftTurnGapAggregation'
    | 'PhasePedAggregation'
    | 'PhaseSplitMonitorAggregation'
    | 'PhaseTerminationAggregation'
    | 'PreemptionAggregation'
    | 'PriorityAggregation'
    | 'SignalEventCountAggregation'
    | 'SignalPlanAggregation',
  params?: GetAggregationStreamDataFromLocationIdentifierAndDataTypeParams,
  signal?: AbortSignal
) => {
  return dataRequest<CompressedDataBase>({
    url: `/api/v1/Aggregation/StreamData/${locationIdentifier}/${dataType}`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetAggregationStreamDataFromLocationIdentifierAndDataTypeQueryKey =
  (
    locationIdentifier: string,
    dataType:
      | 'AggregationApproachBase'
    ...
    return [
      `/api/v1/Aggregation/StreamData/${locationIdentifier}/${dataType}`,
      ...(params ? [params] : []),
    ] as const
  }

export const getGetAggregationStreamDataFromLocationIdentifierAndDataTypeQueryOptions =
  <
    TData = Awaited<
      ReturnType<
        typeof getAggregationStreamDataFromLocationIdentifierAndDataType
      >
    >,
    TError = ProblemDetails,
  >(
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getGetAggregationStreamDataFromLocationIdentifierAndDataTypeQueryKey(
        locationIdentifier,
        dataType,
        params
      )
    ...
    const queryFn: QueryFunction<
      ...
      >
    > = ({ signal }) =>
      getAggregationStreamDataFromLocationIdentifierAndDataType(
        locationIdentifier,
        dataType,
        params,
        signal
...
export type GetAggregationStreamDataFromLocationIdentifierAndDataTypeQueryResult =
  NonNullable<
    Awaited<
      ReturnType<
        typeof getAggregationStreamDataFromLocationIdentifierAndDataType
    ...
    >
  >
export type GetAggregationStreamDataFromLocationIdentifierAndDataTypeQueryError =
  ProblemDetails
...
export function useGetAggregationStreamDataFromLocationIdentifierAndDataType<
  TData = Awaited<
    ReturnType<typeof getAggregationStreamDataFromLocationIdentifierAndDataType>
  >,
  TError = ProblemDetails,
>(
  locationIdentifier: string,
  ...
  const queryOptions =
    getGetAggregationStreamDataFromLocationIdentifierAndDataTypeQueryOptions(
      locationIdentifier,
      dataType,
      params,
      options
...
export const getAggregationDataFromLocationIdentifierAndDataType = (
  ...
  return dataRequest<CompressedDataBase[]>({
    url: `/api/v1/Aggregation/GetData/${locationIdentifier}/${dataType}`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetAggregationDataFromLocationIdentifierAndDataTypeQueryKey = (
  locationIdentifier: string,
  dataType:
    | 'AggregationApproachBase'
    | 'ApproachPcdAggregation'
  ...
  return [
    `/api/v1/Aggregation/GetData/${locationIdentifier}/${dataType}`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetAggregationDataFromLocationIdentifierAndDataTypeQueryOptions =
  <
    TData = Awaited<
      ReturnType<typeof getAggregationDataFromLocationIdentifierAndDataType>
    >,
    TError = ProblemDetails,
  >(
    locationIdentifier: string,
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getGetAggregationDataFromLocationIdentifierAndDataTypeQueryKey(
        locationIdentifier,
        dataType,
        params
      )
...
export type GetAggregationDataFromLocationIdentifierAndDataTypeQueryResult =
  NonNullable<
    Awaited<
      ReturnType<typeof getAggregationDataFromLocationIdentifierAndDataType>
    >
  >
export type GetAggregationDataFromLocationIdentifierAndDataTypeQueryError =
  ProblemDetails
...
export function useGetAggregationDataFromLocationIdentifierAndDataType<
  TData = Awaited<
    ReturnType<typeof getAggregationDataFromLocationIdentifierAndDataType>
  >,
  TError = ProblemDetails,
>(
  ...
  const queryOptions =
    getGetAggregationDataFromLocationIdentifierAndDataTypeQueryOptions(
      locationIdentifier,
      dataType,
      params,
      options
...
export const getAggregationDaysWithDataFromLocationIdentifierAndDataType = (
  ...
  return dataRequest<string[]>({
    url: `/api/v1/Aggregation/GetDaysWithData/${locationIdentifier}/${dataType}`,
    method: 'GET',
    params,
    signal,
  })
...
export const getGetAggregationDaysWithDataFromLocationIdentifierAndDataTypeQueryKey =
  (
    locationIdentifier: string,
    dataType:
      | 'AggregationApproachBase'
    ...
    return [
      `/api/v1/Aggregation/GetDaysWithData/${locationIdentifier}/${dataType}`,
      ...(params ? [params] : []),
    ] as const
  }

export const getGetAggregationDaysWithDataFromLocationIdentifierAndDataTypeQueryOptions =
  <
    TData = Awaited<
      ReturnType<
  ...
  >(
    ...
    const queryKey =
      queryOptions?.queryKey ??
      getGetAggregationDaysWithDataFromLocationIdentifierAndDataTypeQueryKey(
        locationIdentifier,
        dataType,
        params
      )
...
export type GetAggregationDaysWithDataFromLocationIdentifierAndDataTypeQueryResult =
  NonNullable<
    Awaited<
      ReturnType<
        typeof getAggregationDaysWithDataFromLocationIdentifierAndDataType
    ...
    >
  >
export type GetAggregationDaysWithDataFromLocationIdentifierAndDataTypeQueryError =
  ProblemDetails
...
export function useGetAggregationDaysWithDataFromLocationIdentifierAndDataType<
  TData = Awaited<
    ReturnType<
      typeof getAggregationDaysWithDataFromLocationIdentifierAndDataType
    >
...
>(
  ...
  const queryOptions =
    getGetAggregationDaysWithDataFromLocationIdentifierAndDataTypeQueryOptions(
      locationIdentifier,
      dataType,
      params,
      options
