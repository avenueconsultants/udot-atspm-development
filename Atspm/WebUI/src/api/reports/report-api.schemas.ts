...
export type TimeOfDayDataSource = typeof TimeOfDayDataSource[keyof typeof TimeOfDayDataSource];


export const TimeOfDayDataSource = {
  NUMBER_0: 0,
  NUMBER_1: 1,
} as const;
 ...
 * @nullable
 */
export type TimeOfDayOptionsDirectionLaneCounts = {[key: string]: number} | null;
...
export interface TimeOfDayOptions {
  ...
  dataSource?: TimeOfDayDataSource;
  /** @nullable */
  ...
  /** @nullable */
  directionLaneCounts?: TimeOfDayOptionsDirectionLaneCounts;
}
 ...
 * @nullable
 */
export type TimeOfDaySplitPressureDtoThresholdPercentByName = {[key: string]: number} | null;
...
export interface TimeOfDaySplitPressureDto {
  ...
  /** @nullable */
  thresholdPercentByName?: TimeOfDaySplitPressureDtoThresholdPercentByName;
  /** @nullable */
