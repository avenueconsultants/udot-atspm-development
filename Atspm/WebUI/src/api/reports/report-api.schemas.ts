...
// for WebUI - report-api.schemas.ts
//
...
export interface DataPointWithDetectorCheckBase {
  initialX?: string;
  /** @nullable */
...
export interface ReportResultOfPurdueCoordinationDiagramResult {
  error?: ReportError;
  result?: PurdueCoordinationDiagramResult;
...
export interface LinkPivotPcdResult {
  ...
  /** @nullable */
  pcdExisting?: ReportResultOfPurdueCoordinationDiagramResult[] | null;
  /** @nullable */
  pcdPredicted?: ReportResultOfPurdueCoordinationDiagramResult[] | null;
}
...
export interface ReportResultOfAggregationResult {
  error?: ReportError;
  result?: AggregationResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfApproachDelayResult {
  error?: ReportError;
  result?: ApproachDelayResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfApproachSpeedResult {
  error?: ReportError;
  result?: ApproachSpeedResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfApproachVolumeResult {
  error?: ReportError;
  result?: ApproachVolumeResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfArrivalOnRedResult {
  error?: ReportError;
  result?: ArrivalOnRedResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfGapDurationResult {
  error?: ReportError;
  result?: GapDurationResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfGreenTimeUtilizationResult {
  error?: ReportError;
  result?: GreenTimeUtilizationResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLeftTurnGapAnalysisResult {
  error?: ReportError;
  result?: LeftTurnGapAnalysisResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLeftTurnGapDataCheckResult {
  error?: ReportError;
  result?: LeftTurnGapDataCheckResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLeftTurnGapReportResult {
  error?: ReportError;
  result?: LeftTurnGapReportResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLeftTurnSplitFailResult {
  error?: ReportError;
  result?: LeftTurnSplitFailResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLinkPivotForTsd {
  error?: ReportError;
  result?: LinkPivotForTsd;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLinkPivotPcdResult {
  error?: ReportError;
  result?: LinkPivotPcdResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfLinkPivotResult {
  error?: ReportError;
  result?: LinkPivotResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPeakHourResult {
  error?: ReportError;
  result?: PeakHourResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPedActuationResult {
  error?: ReportError;
  result?: PedActuationResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPedDelayResult {
  error?: ReportError;
  result?: PedDelayResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPhaseTerminationResult {
  error?: ReportError;
  result?: PhaseTerminationResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPreemptDetailResult {
  error?: ReportError;
  result?: PreemptDetailResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPreemptServiceRequestResult {
  error?: ReportError;
  result?: PreemptServiceRequestResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPreemptServiceResult {
  error?: ReportError;
  result?: PreemptServiceResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPriorityDetailsResult {
  error?: ReportError;
  result?: PriorityDetailsResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfPrioritySummaryResult {
  error?: ReportError;
  result?: PrioritySummaryResult;
  readonly isSuccess?: boolean;
}

export interface ReportResultOfRampMeteringResult {
  error?: ReportError;
  result?: RampMeteringResult;
  readonly isSuccess?: boolean;
}
...
export interface ReportResultOfSplitFailsResult {
  error?: ReportError;
  result?: SplitFailsResult;
  readonly isSuccess?: boolean;
}
...
export interface ReportResultOfSplitMonitorResult {
  error?: ReportError;
  result?: SplitMonitorResult;
  readonly isSuccess?: boolean;
}
...
export interface TimeSpaceDiagramAverageResult {
  ...
  /** @nullable */
  greenTimeEvents?: DataPointWithDetectorCheckBase[] | null;
}

export interface ReportResultOfTimeSpaceDiagramAverageResult {
  error?: ReportError;
...
export interface TmcForPhaseDto {
  /** @nullable */
  rightTurnEvents?: TmcEventDto[] | null;
  /** @nullable */
  leftTurnEvents?: TmcEventDto[] | null;
}

export interface TimeSpaceDetectorEventDto {
  /** @nullable */
  detectorOn?: string | null;
  /** @nullable */
  detectorOff?: string | null;
...
export interface SrmEntityTrackPoint {
  /** @nullable */
  time?: string | null;
  distance?: number;
  timestampMs?: number;
...
export interface SrmEntityTrack {
  /** @nullable */
  entityId?: string | null;
  /** @nullable */
  points?: SrmEntityTrackPoint[] | null;
  /** @nullable */
  startingIntersection?: string | null;
  headingDirection?: DirectionTypes;
}
...
export interface TimeSpaceDiagramResultForPhase {
  ...
  greenTimeEvents?: DataPointWithDetectorCheckBase[] | null;
  /** @nullable */
  laneByLaneCountDetectors?: TimeSpaceDetectorEventDto[] | null;
  /** @nullable */
  advanceCountDetectors?: TimeSpaceDetectorEventDto[] | null;
  /** @nullable */
  stopBarPresenceDetectors?: TimeSpaceDetectorEventDto[] | null;
  isPhaseOverLap?: boolean;
  ...
  priorityAndPreemptionEvents?: DetectorEventDto[] | null;
  /** @nullable */
  srmEntityTracks?: SrmEntityTrack[] | null;
  /** @nullable */
  offsetLengthChangeEvents?: number | null;
}

export interface ReportResultOfTimeSpaceDiagramResultForPhase {
  error?: ReportError;
...
export interface ReportResultOfTimingAndActuationsForPhaseResult {
  error?: ReportError;
  result?: TimingAndActuationsForPhaseResult;
  readonly isSuccess?: boolean;
}
...
export interface ReportResultOfTransitSignalPriorityResult {
  error?: ReportError;
  result?: TransitSignalPriorityResult;
  readonly isSuccess?: boolean;
}
...
export interface ReportResultOfTurningMovementCountsLanesResult {
  error?: ReportError;
  result?: TurningMovementCountsLanesResult;
  readonly isSuccess?: boolean;
}
...
export interface TurningMovementCountsResult {
  /** @nullable */
  charts?: ReportResultOfTurningMovementCountsLanesResult[] | null;
  /** @nullable */
...
export interface ReportResultOfTurningMovementCountsResult {
  error?: ReportError;
  result?: TurningMovementCountsResult;
  readonly isSuccess?: boolean;
}
...
export interface ReportResultOfVolumeResult {
  error?: ReportError;
  result?: VolumeResult;
  readonly isSuccess?: boolean;
}
...
export interface ReportResultOfWaitTimeResult {
  error?: ReportError;
...
export interface ReportResultOfWatchDogResult {
  error?: ReportError;
...
export interface ReportResultOfYellowRedActivationsResult {
  error?: ReportError;
  result?: YellowRedActivationsResult;
  readonly isSuccess?: boolean;
}
...
export interface TimeSpaceDiagramSrmPhaseOverlay {
  /** @nullable */
  locationIdentifier?: string | null;
  /** @nullable */
  phaseType?: string | null;
...
export interface WatchDogProductInfo {
  ...
  name?: string | null;
  /** @nullable */
  model?: WatchDogModelOfWatchDogFirmwareCount[] | null;
}
