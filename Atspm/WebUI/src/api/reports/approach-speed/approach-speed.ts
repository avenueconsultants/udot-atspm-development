...
export type getApproachSpeedTestDataResponse200 = {
  data: ReportResultOfApproachSpeedResult[]
  status: 200
}
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GetApproachSpeedReportDataMutationBody = NonReadonly<ApproachSpeedOptions> | undefined
