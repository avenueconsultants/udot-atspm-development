...
export const getGetTimeSpaceDiagramAverageTestDataQueryOptions = <TData = Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError = ProblemDetails>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTimeSpaceDiagramAverageTestDataQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetTimeSpaceDiagramAverageTestData<TData = Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError = ProblemDetails>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetTimeSpaceDiagramAverageTestData<TData = Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError = ProblemDetails>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTimeSpaceDiagramAverageTestData>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get example data for testing
...
export const useGetTimeSpaceDiagramAverageReportData = <TError = ProblemDetails,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getGetTimeSpaceDiagramAverageReportDataMutationOptions(options), queryClient);
    }
