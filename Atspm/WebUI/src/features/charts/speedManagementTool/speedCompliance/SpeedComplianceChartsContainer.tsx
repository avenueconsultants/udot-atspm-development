              ...
              {tableData.avgSpeed.map((avgSpeed, i) => (
                ...
                >
                  {avgSpeed !== null && tableData.speedLimit[i] !== null
                    ? `${
                        avgSpeed - tableData.speedLimit[i] > 0
                          ? `+ ${(avgSpeed - tableData.speedLimit[i]).toFixed(
                              1
                            )}`
              ...
              {tableData.eightyFifth.map((eightyFifth, i) => (
                ...
                >
                  {eightyFifth !== null && tableData.speedLimit[i] !== null
                    ? `${
                        eightyFifth - tableData.speedLimit[i] > 0
                          ? `+ ${(
                              eightyFifth - tableData.speedLimit[i]
                            ).toFixed(1)}`
                          : `${(eightyFifth - tableData.speedLimit[i]).toFixed(
                              1
                            )}`
                      }`
                    : 'No Data'}
