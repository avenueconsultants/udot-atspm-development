// features/data/components/ReportsApiAgencyCard.tsx
...
export default function ReportsApiAgencyCard({
  rows,
  users,
  title = 'Reports usage by agency',
  height = 320,
  maxBars = 30,
}: {
  rows: UsageEntry[]
